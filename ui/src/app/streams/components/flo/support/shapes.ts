...
joint.shapes.flo.LinkDataflow = joint.shapes.flo.Link.extend({
  ...
  toolMarkup: [
    ...
    '<rect class="link-tools-container" width="28" height="28" transform="translate(9, 7)"/>',
    '<g class="tool-remove" event="remove" transform="scale(.7)  translate(10, 6)">',
    '<circle r="11"/>',
    '<path transform="scale(.8) translate(-16.5, -16.5)" d="M24.778,21.419 19.276,15.917 24.777,10.415 21.949,7.585' +
